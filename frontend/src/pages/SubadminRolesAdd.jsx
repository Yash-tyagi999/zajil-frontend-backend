...
function SubadminRolesAdd() {
  const initialsState = {
    ...
    moduleName: [
      ...
      { name: "Banner Management", read: false, fullAccess: false },
      { name: "Company Management", read: false, fullAccess: false },
      { name: "Vehicle  Management", read: false, fullAccess: false },
