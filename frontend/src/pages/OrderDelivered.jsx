...
function OrderDelivered() {
  ...
  const handleDateSearch = (e) => {
    ...
    try {
      ...
      if (timeFrame) {
        ...
        filtered = filtered.filter((b) => {
          const orderDate = new Date(b.orderDeliveredDate);
  ...
  const deliveredOrders = filteredOrders.filter(
    (o) => o.orderStatus === "Pickup Delivered"
  );
      ...
      <div className="WrapperArea">
        <div className="WrapperBox">
          <div className="TitleBox">
            <h4 className="Title">Delivered Order</h4>
          </div>
          ...
          <div className="TableList">
            ...
            {!loading && deliveredOrders.length === 0 && <p>No Order found.</p>}
            ...
            {!loading && deliveredOrders.length > 0 && (
              <table style={{ width: "125%" }}>
                ...
                <tbody>
                  {deliveredOrders.map((currentOrder, index) => (
                    <tr key={currentOrder.orderId}>
                      ...
                      <td>
                        {new Date(
                          currentOrder.orderDeliveredDate
                        ).toLocaleDateString()}
                      </td>
                      <td>
